...
The core mechanic. Everything else in this document is harness.
...
### The mirror quotes its sources

Dreams about *you*—"you've changed your mind about X", "you keep circling Y"—are the hook. Most people like reading judgments about themselves, in a morbidly curious way. They are also the failure mode: an LLM generating observations about a person drifts toward horoscope. Flattering, vague, checkable by no one.

The countermeasure is a hard rule: **dreams speak predominantly in your own words.** Quote, don't paraphrase. Quoting is more reliable (no summarization drift) and more provoking (the friction between your March words and your July words *is* the thought). The dream's own voice is for juxtaposition and framing, not restatement. Link the actual notes. A dream is interesting exactly insofar as it is checkable.

### Review is a garden, not an inbox
