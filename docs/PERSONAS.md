...
**Pains:** the morning pages are a dumping ground she never rereads. So the obsessions inside them are invisible to her. She knows there are four years of recurring images in that stack of notebooks and no way to see.

**Wants:**
- Capture in under 15 seconds—dictate the pages while making coffee, or photograph them.
- Oblique Strategies generated from her own Subconscious. *Provocations* rather than summaries: "you've drawn the same doorway four times this month," "these two notes from different years want to be the same piece."
- Artist date suggestions
